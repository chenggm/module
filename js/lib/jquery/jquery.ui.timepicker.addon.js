...
define("lib/jquery/jquery.ui.timepicker.addon",function(require, exports, module) {
	...
	*/
	var Timepicker = function() {
		...
		this.regional[''] = { // Default regional settings
			currentText: _lang("datetimepicker.now"), //'现在',
			closeText: _lang("datetimepicker.clear"), //'清空',
			amNames: ['AM', 'A'],
			pmNames: ['PM', 'P'],
			timeFormat: 'HH:mm',
			timeSuffix: '',
			...
			timeText: '时间',
			hourText: _lang("datetimepicker.hour"), //'时',
			minuteText: _lang("datetimepicker.minutes"), //'分',
			secondText: _lang("datetimepicker.seconds"), //'秒',
			millisecText: '毫秒',
			microsecText: '微秒',
			timezoneText: '时区',
			isRTL: false
