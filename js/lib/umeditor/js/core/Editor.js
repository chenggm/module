...
(function () {
    ...
    Editor.prototype = {
         ...
         * * @grammar editor.setOpt(key,value,true); //覆盖已存在键值对 by lkl
         */
        setOpt: function (key, val,reset) {
            var obj = {};
            ...
            utils.extend(this.options, obj, reset?false:true);
        },
...
//            }
        ...
        setShow: function () {
            ...
            for(var i=0;i< me.container.childNodes.length;i++){
                var node = me.container.childNodes.item(i);
                if(node.className == "edui-toolbar")
                {
                    node.style.display = "";
                    return;
                }
