define('module/teditor/widget',function(require, exports, module){
    var $ = require('jquery');
    ...
    function _createClass(ClassObj, properties, supperClass) {
        ClassObj.prototype = $.extend2(
            $.extend({}, properties),
            (ui[supperClass] || _widget).prototype,
            true
        );
        ClassObj.prototype.supper = (ui[supperClass] || _widget).prototype;
        //父class的defaultOpt 合并
        if( ui[supperClass] && ui[supperClass].prototype.defaultOpt ) {

            var parentDefaultOptions = ui[supperClass].prototype.defaultOpt,
    ...
    exports.defineUI = function (className, properties, supperClass) {
            var ClassObj = ui[className] = _createClass(function (options, $el) {
                    var _obj = function () {
                    };
    ...
    exports.registerWidget = function(name,pro,cb){
    ...
    exports.getWidgetData = function(name){
        return _widgetData[name]
    }

    exports.setWidgetBody = function(name,$widget,editor){
