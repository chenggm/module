 ...
 * 静态工具函数
 */
define('module/core/utils',function(require, exports, module){
  ...
  utils = {
     ...
     * @name inherits
     * @grammar utils.inherits(subClass,superClass) => subClass
     * @example
     * function SuperClass(){
     *     this.name = "小李";
     * }
     ...
     * testDefer();   =>  "延迟输出！";
     * //互斥延迟执行
     * var testDefer1 = defer(test,1000,true);
     * testDefer1();   =>  //本次不执行
     * testDefer1();   =>  "延迟输出！";
     */
     ...
     * @name indexOf
     * @grammar utils.indexOf(array,item)  => index|-1  //默认从数组开头部开始搜索
     * @grammar utils.indexOf(array,item,start)  => index|-1  //start指定开始查找的位置
     */
     ...
     * 移除数组array中的元素item
     * @name removeItem
     * @grammar utils.removeItem(array,item)
     */
     ...
     * utils.unhtml(html);   ==>  &lt;body&gt;You say:&quot;你好！Baidu &amp; UEditor!&quot;&lt;/body&gt;
     * utils.unhtml(html,/[<>]/g)  ==>  &lt;body&gt;You say:"你好！Baidu & UEditor!"&lt;/body&gt;
     */
     ...
     * 将str中的转义字符还原成html字符
     * @name html
     * @grammar utils.html(str)  => String   //详细参见<code><a href = '#unhtml'>unhtml</a></code>
     */
    html:function (str) {
     ...
     * @name loadFile
     * @grammar utils.loadFile(doc,obj)
     * @grammar utils.loadFile(doc,obj,fn)
     * @example
     ...
     * 判断obj对象是否为空
     * @name isEmptyObject
     * @grammar utils.isEmptyObject(obj)  => true|false
     * @example
     ...
     * 统一将颜色值使用16进制形式表示
     * @name fixColor
     * @grammar utils.fixColor(name,value) => value
     * @example
     ...
     * @name clone
     * @grammar utils.clone(source) => anthorObj 新的对象是完整的source的副本
     * @grammar utils.clone(source,target) => target包含了source的所有内容，重名会覆盖
     */
     ...
     * 转换cm/pt到px
     * @name transUnitToPx
     * @grammar utils.transUnitToPx('20pt') => '27px'
     * @grammar utils.transUnitToPx('0pt') => '0'
     */
   ...
   * 判断str是否为字符串
   * @name isString
   * @grammar utils.isString(str) => true|false
  */
  /**
   * 判断array是否为数组
   * @name isArray
   * @grammar utils.isArray(obj) => true|false
   */
  /**
   * 判断obj对象是否为方法
   * @name isFunction
   * @grammar utils.isFunction(obj)  => true|false
   */
  /**
   * 判断obj对象是否为数字
   * @name isNumber
   * @grammar utils.isNumber(obj)  => true|false
  */
